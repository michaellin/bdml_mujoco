...
class Bookshelf(SingleArmEnv):
    ...
    def _reset_internal(self):
        ...
        if not self.deterministic_reset:
            ...
            y_range = np.linspace(-0.21, 0.21, n)
            ...
            for obj_pos, obj_quat, obj in object_placements.values():
                ...
                if obj.name is not "goal_object":
    ...
    def _check_success(self):
        ...
        if lifted_bool and removed_bool:
            ...
            return True, True, elapsed_time, total_disturbance, self.trial_counter-1
        elif (elapsed_time > 60) or (goal_object_pos[2] < 0.5):
            return True, False, elapsed_time, total_disturbance, self.trial_counter-1
        else: 
            return False, False, None, None, self.trial_counter-1
