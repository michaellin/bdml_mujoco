...
class CabinetArena(Arena):
    ...
    def __init__(
        ...
        #self.table_cabinet_body = self.table_body.find("./body[@name='cabinet']")
        #self.table_cabinet_collision = self.table_cabinet_body.find("./body[@name='cabinet_collision']")
        #self.table_cabinet_visual = self.table_cabinet_body.find("./body[@name='cabinet_visual']")
